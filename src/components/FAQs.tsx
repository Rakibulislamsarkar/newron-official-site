...
const FaQs = () => {
    return (
        <div className={'bg-background-secondary py-20 sm:py-40 px-4 md:px-6 lg:px-10'}>
            <article className={"flex flex-col md:flex-row gap-8 md:gap-16 justify-between mx-auto max-w-[1536px] "}>
