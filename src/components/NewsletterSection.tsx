        ...
        <aside className={""}>
            <GlassCard>
                <div className={"min-h-[400px] flex flex-col gap-4 justify-center items-center text-center py-12"}>
                    ...
                    <form className={"mt-4 flex justify-center items-stretch w-full max-w-md sm:max-w-lg "} onSubmit={handleSubscribe}>
                        <div className="relative rounded-sm shadow-sm h-full flex-grow">
                            <div className="pointer-events-none absolute inset-y-0 left-0 items-center pl-4 hidden sm:flex">
                            ...
                            <input
                                ...
                                className="block w-full rounded-full border-0 py-3 pl-3 sm:pl-12 text-gray-100 bg-zinc-800 bg-opacity-50 ring-1 ring-inset ring-gray-800 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-neutral-600 focus:border-none focus:outline-none sm:text-sm sm:leading-6 placeholder:text-sm"
                                placeholder="you@example.com"
                            />
                        </div>
                        <button type={"submit"} disabled={isSendingData} className={clsx("flex items-center justify-center gap-2 btn-primary px-4 py-0.5 text-xs sm:text-sm font-medium rounded-r-sm", {"animate-bounce" : isSendingData})}>
                            Subscribe
                            {
