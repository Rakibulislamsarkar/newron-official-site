...
const PrivacyPolicy = () => {
    return (
        <div className="p-10 mt-12">
            ...
            <p className="text-zinc-400 mb-2 mt-2 text-sm">Last Updated: July 10, 2023</p>
            <p className="description mb-10">This Privacy Policy describes how Newron.ai
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">1. Information We Collect</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">2. How We Use Your Information</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">3. Sharing of Information</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">4. Security</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">5. International Data Transfers</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">6. Your Rights</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2 ">7. Changes to this Privacy Policy</h2>
