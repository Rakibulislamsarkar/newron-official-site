...
const TermsOfService = () => {
    return (
        <div className="p-10 mt-12">
            <h1 className="heading mb-4">Terms of Service</h1>
            <p className="text-zinc-400 text-sm">Last Updated: July 10, 2023</p>
            <p className="mt-8 description">Welcome to Newron.ai. Please read these Terms of Service
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">1. Services</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">2. Acceptance of Terms</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">3. Changes to Terms</h2>
            <p className="text-zinc-400">We reserve the right, at our sole discretion, to modify or replace these Terms
                ...
                discretion.</p>
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">4. Intellectual Property</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">5. User Conduct</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">6. Privacy Policy</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">7. Limitation of Liability</h2>
            <p className="text-zinc-400">In no event shall Newron.ai, nor its directors, employees, partners, agents,
                ...
                essential purpose.</p>
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">8. Governing Law</h2>
            ...
            <h2 className="text-zinc-100 text-2xl mt-4 mb-2">9. Contact Us</h2>
